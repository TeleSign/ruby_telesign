...
class VerifyTest < Minitest::Test
  ...
  def test_verify_sms req_mock
    ...
    p = Verify.new(@expected_cid, @expected_secret_key)
  ...
  # @mock.patch.object(requests, "post")
  def test_verify_sms_default_code req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
    ...
    p = Verify.new(@expected_cid, @expected_secret_key)
    p.sms(@expected_phone_no, language=@expected_language)
    ...
    assert_equal kwargs["data"]["phone_number"], @expected_phone_no, "Phone number field did not match"
    assert_equal kwargs["data"]["language"], @expected_language, "Language field did not match"
    assert_equal len("%s" % kwargs["data"]["verify_code"]), 5, "Expected default verify code to be 5 digits"
    assert_false kwargs['proxies']
  end

  # @mock.patch.object(requests, "post")
  def test_verify_call_default_code req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
    ...
    p = Verify.new(@expected_cid, @expected_secret_key)
    p.call(@expected_phone_no, language=@expected_language)
  ...
  def test_status_check req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
  ...
  # @mock.patch.object(requests, "post")
  def test_verify_sms_with_proxy req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
  ...
  # @mock.patch.object(requests, "post")
  def test_verify_call_with_proxy req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
  ...
  # @mock.patch.object(requests, "get")
  def test_status_check_with_proxy req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
  ...
  # @mock.patch.object(requests, "get")
  def test_report_code_with_proxy req_mock
    response = mock.Mock()
    response.reason = ""
    response.status_code = 200
    response.text = @expected_data
